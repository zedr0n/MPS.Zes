...
<model ref="r:b72e4e24-4ac6-4029-b790-745c884bc535(market)">
  ...
  <node concept="0yj_U" id="7ambIhgUIG3">
    <property role="2hLNu2" value="true" />
    <property role="TrG5h" value="SubmitOrder" />
    <property role="3GE5qa" value="Commands" />
    <ref role="0xEmz" node="mlkkOgPVoZ" resolve="Order" />
    <node concept="fp7cb" id="7ambIhgUIG5" role="0JheC">
      <property role="TrG5h" value="target" />
    </node>
  </node>
  <node concept="0xgbA" id="7ambIhgUITK">
    <property role="3GE5qa" value="Commands" />
    <ref role="0xgvH" node="7ambIhgUIG3" resolve="SubmitOrder" />
  </node>
